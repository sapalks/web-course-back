...
app.get('/main/verification_code', function (req, res) {
    ...
    const options = {
        body: "grant_type=authorization_code&client_id=3741c6c470c84866a52b8fa57bcc69fb&client_secret=c46af270358b409b9dfdc5eb22006ea6&code=" + queryData.code,
        method: 'post'
    };
...
app.post('/refreshToken', function(req, res) {
    ...
    const options = {
        body: "grant_type=refresh_token&client_id=3741c6c470c84866a52b8fa57bcc69fb&client_secret=c46af270358b409b9dfdc5eb22006ea6&refresh_token=" + req.body.refresh_token,
        method: 'post'
    };
