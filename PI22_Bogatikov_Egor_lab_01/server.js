...
app.listen(4578, function () {
    logger.info("{" + new Date().toUTCString() + "} Server started on port 4578")
})
...
var calculate = function (value1, value2, operation) {
    ...
    switch (operation) {
        ...
        case 'division':
            ...
            break;
        default:
            return ({status:'error', body:'Wrong ' + operation})
    }
...
app.listen(() => {
    console.log(`Example app listening at http://localhost:4578`)
})
