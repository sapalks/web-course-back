...
class studentController {
    ...
    async getStudentInClasses(req, res) {
    ...
    async createStudent(req, res) {
        ...
        const result = await db.query('INSERT INTO player(login, mail, division, classID) VALUES ($1, $2, $3, $4) RETURNING *', [login, mail, division, classID]);
        res.json(result.rows[0]);  
    }
